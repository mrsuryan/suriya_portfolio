...
export function LinkedInIconSm() {
  return (
    <svg className="ico-linkedin" viewBox="0 0 24 24" fill="none" width={18} height={18}>
      <rect x="2" y="2" width="20" height="20" rx="5"
        fill="rgba(59,130,246,.15)" stroke="currentColor" strokeWidth="1.4" />
      <rect className="badge" x="5" y="9" width="3.5" height="9" rx="1" fill="currentColor" />
      <circle cx="6.75" cy="6.75" r="1.75" fill="currentColor" />
